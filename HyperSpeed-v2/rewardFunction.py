def reward_function(params):
    # Example of rewarding the agent to follow the center line and finish under 30 seconds without going off-track
    ...
    # Additional reward for finishing the track under 30 seconds
    if is_reversed:
        target_time = 30  # Adjust if needed for a different target time in seconds
    else:
        target_time = 30  # Adjust if needed for a different target time in seconds
